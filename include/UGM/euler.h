...
namespace Ubpa {
	...
	template<typename T>
	struct euler : SIIT_CRTP<TemplateList<IArray1D_Util, IArrayInOut, IArray>, euler<T>, TypeList<TypeList<T, Size<3>>, T>> {
		using SIIT_CRTP<TemplateList<IArray1D_Util, IArrayInOut, IArray>, euler<T>, TypeList<TypeList<T, Size<3>>, T>>::SIIT_CRTP;
