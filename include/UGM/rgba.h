...
namespace Ubpa {
	template<typename T>
	struct rgba : SIIT_CRTP<TemplateList<IArray1D_Util, IArrayInOut>, rgba<T>, TypeList<TypeList<T, Size<4>>, T>> {
		using Base = SIIT_CRTP<TemplateList<IArray1D_Util, IArrayInOut>, rgba<T>, TypeList<TypeList<T, Size<4>>, T>>;
		using Base::Base;
